...
Reason: The data contains an multiple instances of the same AI with different values. If the same AI appears more than once on a physical entity, whether is a single or multiple barcodes or data structures, all occurrences must have the same value.
